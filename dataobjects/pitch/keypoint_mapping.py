...
class PitchKeypointMapping:
    ...
    EDGES = (
        ...
        (FIELD_TOP_LEFT, MIDFIELD_TOP),
        (FIELD_TOP_RIGHT, MIDFIELD_TOP),
        (FIELD_BOTTOM_LEFT, MIDFIELD_BOTTOM),
        (FIELD_BOTTOM_RIGHT, MIDFIELD_BOTTOM),

        # Midfield line
        (MIDFIELD_TOP, CIRCLE_TEN_YARD_TOP),
        (MIDFIELD_BOTTOM, CIRCLE_TEN_YARD_BOTTOM),
        (CIRCLE_TEN_YARD_TOP, CIRCLE_TEN_YARD_BOTTOM),

        # Vertical field lines (left)
        (FIELD_TOP_LEFT, LEFT_PENALTY_TOP_LEFT),
        (LEFT_PENALTY_TOP_LEFT, LEFT_GOALKEEPER_TOP_LEFT),
        (LEFT_GOALKEEPER_TOP_LEFT, LEFT_GOALKEEPER_BOTTOM_LEFT),
        (LEFT_GOALKEEPER_BOTTOM_LEFT, LEFT_PENALTY_BOTTOM_LEFT),
        (LEFT_PENALTY_BOTTOM_LEFT, FIELD_BOTTOM_LEFT),

        # Vertical field lines (right)
        (FIELD_TOP_RIGHT, RIGHT_PENALTY_TOP_RIGHT),
        (RIGHT_PENALTY_TOP_RIGHT, RIGHT_GOALKEEPER_TOP_RIGHT),
        (RIGHT_GOALKEEPER_TOP_RIGHT, RIGHT_GOALKEEPER_BOTTOM_RIGHT),
        (RIGHT_GOALKEEPER_BOTTOM_RIGHT, RIGHT_PENALTY_BOTTOM_RIGHT),
        (RIGHT_PENALTY_BOTTOM_RIGHT, FIELD_BOTTOM_RIGHT),

        # Penalty box (left)
        (LEFT_PENALTY_TOP_LEFT, LEFT_PENALTY_TOP_RIGHT),
        (LEFT_PENALTY_TOP_RIGHT, LEFT_PENALTY_BOTTOM_RIGHT),
        (LEFT_PENALTY_BOTTOM_RIGHT, LEFT_PENALTY_BOTTOM_LEFT),

        # Penalty box (right)
        (RIGHT_PENALTY_TOP_RIGHT, RIGHT_PENALTY_TOP_LEFT),
        (RIGHT_PENALTY_TOP_LEFT, RIGHT_PENALTY_BOTTOM_LEFT),
        (RIGHT_PENALTY_BOTTOM_LEFT, RIGHT_PENALTY_BOTTOM_RIGHT),

        # Goalie's box (left)
        (LEFT_GOALKEEPER_TOP_LEFT, LEFT_GOALKEEPER_TOP_RIGHT),
        (LEFT_GOALKEEPER_TOP_RIGHT, LEFT_GOALKEEPER_BOTTOM_RIGHT),
        (LEFT_GOALKEEPER_BOTTOM_RIGHT, LEFT_GOALKEEPER_BOTTOM_LEFT),

        # Goalie's box (right)
        (RIGHT_GOALKEEPER_TOP_RIGHT, RIGHT_GOALKEEPER_TOP_LEFT),
        (RIGHT_GOALKEEPER_TOP_LEFT, RIGHT_GOALKEEPER_BOTTOM_LEFT),
        (RIGHT_GOALKEEPER_BOTTOM_LEFT, RIGHT_GOALKEEPER_BOTTOM_RIGHT),
    )
